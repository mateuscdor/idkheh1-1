...
async function execute(bosco, msg, match) {
    ...
    await bosco.sendMessage(msg.key.remoteJid, { image: data.data, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply: { title: bot_name, body: bot_footer, previewType: "PHOTO", thumbnail: bot_img, sourceUrl: owner_link } }, caption: `QR code for 👇\n` + "```" + match + "```" }, { quoted: msg });
}
