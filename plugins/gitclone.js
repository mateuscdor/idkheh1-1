...
async function execute(bosco, msg, match) {
    ...
    await bosco.sendMedia(msg.key.remoteJid, url, msg, { contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply: { title: bot_footer, body: '', previewType: "PHOTO", thumbnail: bot_img, sourceUrl: match } }, fileName: filename });
}
module.exports = {
    command: "gitclone", 
    Type: "download", 
