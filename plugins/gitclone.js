...
async function execute(bosco, msg, match) {
    ...
    await bosco.sendMedia(from, url, msg, { contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply: { title: bot_name, body: bot_prefix, previewType: "PHOTO", thumbnail: bot_img, sourceUrl: q } }, fileName: filename });
}
module.exports = {
    command: "gitclone", 
    Type: "download", 
